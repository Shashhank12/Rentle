...
<div class="renting_reviews_list_item">
    <div class="renting_reviews_list_item_1">
        <div class="renting_reviews_list_item_1_module">
            <div class="renting_review_full_name"> <%=name%> </div>
            <div class="renting_review_stars"> <%=formattedStars%> <i class="fas fa-star" id="renting_review_star_icon_1"></i></div>
        </div>
    </div>
    <div class="renting_review_description"> <%=description%> </div>
</div>
<%
        }
