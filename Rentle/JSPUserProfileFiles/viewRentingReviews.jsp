...
<div class="renter_reviews_list_item">
    <div class="renter_reviews_list_item_1"></div>
        <div class="renter_reviews_list_item_1_module">
            <div class="renter_review_full_name"> <%=name%> </div>
            <div class="renter_review_stars"> <%=formattedStars%> <i class="fas fa-star" id="renter_review_star_icon_1"></i></div>
        </div>
    </div>
    <div class="renter_review_description"> <%=description%> </div>
</div>
<%
        }
